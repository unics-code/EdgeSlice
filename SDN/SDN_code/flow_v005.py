...
def create_topology(*args):
	...
	for u in range(0,len(b1_u)):
		s_num=2
		temp = add_flow_with_meter(switch[s_num],11,5,b1_u[u],m_l[u][s_num][0],0,switch,b_num)
		f_l = add_f_l(f_l,u,s_num,temp)
		s_num=2
		temp = add_flow_with_meter(switch[s_num],5,11,b1_u[u],m_l[u][s_num][0],1,switch,b_num,99)
		f_l = add_f_l(f_l,u,s_num,temp)
